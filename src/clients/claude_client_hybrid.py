...
async def main_batched(
    ...
    """Process batched requests with Claude using hybrid prompt."""
    client = ClaudeAsyncClient(api_key, model_name)
    sem = asyncio.Semaphore(concurrency)

    # Load hybrid prompt once
    prompt_path = Path(__file__).parent.parent / "prompts" / "claude_docvqa_hybrid.md"
...
Choose the appropriate strategy (direct_extraction or structured_analysis) based on question complexity.
